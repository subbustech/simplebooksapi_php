...
class DB {
	...
	public static function connectWriteDB() {
		if(self::$writeDBConnection === null) {
				self::$writeDBConnection = new PDO('mysql:host=localhost;dbname=simplebooksdb;charset=utf8', 'subbu123', 'subbu123');
	...
	public static function connectReadDB() {
		if(self::$readDBConnection === null) {
				self::$readDBConnection = new PDO('mysql:host=localhost;dbname=simplebooksdb;charset=utf8', 'subbu123', 'subbu123');
